          ...
          GAME_RENDERER_3D.on('frame', () => {
            try {
              ...
              if (gameCamera && GAME_RENDERER_3D) {
                ...
                // Simple alignment: center ground in viewport (lookAtOffsetY: 0)
                // Ground plane (Y=0) stays in viewport center, aligned with gameplay path
                syncThreeCamera({
                  ...
                  config: {
                    ...
                    lookAtOffsetY: 0                  // Look at ground center
                  }
                });
              }
            } catch (err) {
