...
const HARD_DEFAULT_CANVAS_HEIGHT = 460;
const HARD_DEFAULT_GROUND_OFFSET = 140;
...
function resolveCanvasHeight(mapConfig){
...
function resolveGroundRatio(mapConfig, canvasHeight, groundOffset){
  const editorConfig = coerceMapEditorConfig(mapConfig);
  const rootConfig = getRootConfig();
  const candidates = [
...
function resolveGroundOffset(mapConfig, canvasHeight){
  const editorConfig = coerceMapEditorConfig(mapConfig);
  const rootConfig = getRootConfig();
...
function resolveCustomAreaEntry(mapConfig){
  const editorConfig = coerceMapEditorConfig(mapConfig);
...
function resolveMapEditorDefaults(mapConfig){
...
export {
  HARD_DEFAULT_CANVAS_HEIGHT,
  HARD_DEFAULT_CUSTOM_AREA_ENTRY,
  HARD_DEFAULT_GROUND_OFFSET,
  HARD_DEFAULT_LAYOUT_ID,
  HARD_PREVIEW_STORAGE_PREFIX,
  MAP_CONFIG_DEFAULTS,
  coerceMapConfig,
  coerceMapEditorConfig,
  pickDefaultLayoutEntry,
  resolveCanvasHeight,
  resolveCustomAreaEntry,
  resolveDefaultLayoutId,
  resolveGroundOffset,
  resolveGroundRatio,
  resolveMapEditorDefaults,
