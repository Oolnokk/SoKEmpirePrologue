  ...
  layout: {
    ...
    fitter: {
      ...
      overlap: __existingGameConfig.layout?.fitter?.overlap ?? {
        ...
        collapseOrder: [],
        preserveRegions: ['tableView', 'controls', 'sidebar'],
    ...
    projectionMapping: {
      ...
      selectorVarsByProjId: __existingGameConfig.layout?.projectionMapping?.selectorVarsByProjId ?? {
        ...
        'table-view': {
          ...
          '.focusMiniCards, .focusMiniCards .tableViewCard, .focusMiniCards .tableViewCard img': ['--layout-card-mini-base-width', '--layout-card-mini-base-height', '--layout-card-scale'],
          '.focusAvatar, .focusAvatar canvas, .seatPortrait': ['--layout-seat-avatar-size', '--layout-human-seat-avatar-size', '--layout-cinematic-avatar-size', '--layout-sidebar-content-scale'],
          '.focusActionText, .focusSubtext': ['--layout-challenge-font-scale', '--layout-fit-font-scale'],
        },
        sidebar: {
