...
window.CONFIG.time.startTime24h = 12; // Default start time (24h format)
window.CONFIG.time.timeScale = 0.05; // Hours per second
window.CONFIG.time.paused = false; // Pause automatic time progression
...
const MOVEMENT_PROFILES = {
  combat: {
    ...
    amp: 1.0,
    poses: {
      A: { torso: 30, lShoulder: 0, lElbow: -45, rShoulder: 90, rElbow: 0, lHip: 0, lKnee: 45,  rHip: 180, rKnee: 90 },
      B: { torso: 40, lShoulder: 90, lElbow: 0, rShoulder: 0, rElbow: -45, lHip: 180, lKnee: 90,  rHip: 0,   rKnee: 45 }
    },
    idlePoses: {
      A: { torso: 0, lShoulder: 285, lElbow: -15, rShoulder: 285, rElbow: -15, lHip: 270, lKnee: 70, rHip: 110, rKnee: 70, },
      B: { torso: 0, lShoulder: 285, lElbow: -15, rShoulder: 285, rElbow: -15, lHip: 270, lKnee: 70, rHip: 110, rKnee: 70, },
    },
    idleAmp: 0.4
  },
  nonCombat: {
    ...
    amp: 1.0,
    poses: {
      A: { torso: 0, lShoulder: 180, lElbow: 0, rShoulder: 0, rElbow: 0, lHip: 55, lKnee: 0, rHip: 125, rKnee: 45 },
      B: { torso: 5, lShoulder: 0, lElbow: 0, rShoulder: 180, rElbow: 0, lHip: 125, lKnee: 45, rHip: 55, rKnee: 0 },
    },
    idlePoses: {
  ...
  fighters: {
    ...
    'Mao-ao_M': {
      ...
      spriteStyle: {
          ...
          xformUnits: "percent",
          xform: {
            torso:    { ax:0.075,  ay:-0.1, scaleX:0.8, scaleY:1.25, rotDeg:90 },
            head:     { ax:0, ay:-0.1, scaleX:0.95, scaleY:1.14, rotDeg:90 },
    ...
    'Mao-ao_F': {
      ...
      spriteStyle: {
          ...
          xformUnits: "percent",
                    xform: {
            torso:    { ax:0.075,  ay:-0.1, scaleX:0.9, scaleY:1.25, rotDeg:90 },
            head:     { ax:0, ay:-0.1, scaleX:0.95, scaleY:1.14, rotDeg:90 },
            armUpper: { ax:-0.2,  ay:0,  scaleX:1.6, scaleY:2.8, rotDeg:-0 },
            armLower: { ax:0.35,  ay:0,  scaleX:1.7, scaleY:2.1, rotDeg:-0 },
            legUpper: { ax:-0.10, ay:0,  scaleX:1.7, scaleY:2.75,  rotDeg:0 },
