...
window.CONFIG = {
  ...
  fighters: {
    TLETINGAN: {
      ...
      hierarchy: { legsFollowTorsoRotation: false },
      ik: { calvesOnly: true },
      basePose: { torso:0, lShoulder:0, lElbow:0, rShoulder:0, rElbow:0, lHip:90, lKnee:0, rHip:90, rKnee:0 },
  ...
  combos: {
    unarmed:         { sequence:['KICK','PUNCH','KICK','PUNCH'], altSequence:['PUNCH','KICK','PUNCH','KICK'], timerDuration:3000 },
    'dagger-swords': { sequence:['SLASH','STAB','SLASH','STAB'], altSequence:['STAB','SLASH','STAB','SLASH'], timerDuration:2500 },
    sarrarru:        { sequence:['THRUST','SWEEP','THRUST','SWEEP'], altSequence:['SWEEP','THRUST','SWEEP','THRUST'], timerDuration:3500 },
    'light-greatblade': { sequence:['CHOP','SLASH','CHOP','SLASH'], altSequence:['SLASH','CHOP','SLASH','CHOP'], timerDuration:4000 },
    greatclub:       { sequence:['SMASH','SWING','SMASH','SWING'], altSequence:['SWING','SMASH','SWING','SMASH'], timerDuration:3000 },
    hatchets:        { sequence:['HACK','HACK','HACK','TOSS'], altSequence:['HACK','TOSS','HACK','TOSS'], timerDuration:2800 }
  }
};
