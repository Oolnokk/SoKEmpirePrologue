...
window.CONFIG = {
  ...
  fighters: {
    ...
    'Mao-ao_M': {
      ...
      hierarchy: { legsFollowTorsoRotation: false },
      ik: { calvesOnly: true },
      limits: { torso:{ absMin:-45, absMax:90 }, shoulder:{ relMin:-360, relMax:-90 }, elbow:{ relMin:-170, relMax:0 }, hip:{ absMin:90, absMax:210 }, knee:{ relMin:0, relMax:170 }, head:{ relMin:270, relMax:360 } },
      headTracking: {
        offsetDeg: -70
      },
      offsets: {
